...
#load models
load('06_brms/model_null_ch_medium.Rdata')
load('06_brms/model_rw_ch_medium.Rdata')
load('06_brms/model_rw_ch_cond_medium.Rdata')

loo_null_ch <- loo(bayes_null_ch_medium)
save(loo_null_ch, file = '08_loo_model_comparison/loo_null_ch.Rdata')
loo_rw_ch <- loo(bayes_rw_ch_medium)
save(loo_rw_ch, file = '08_loo_model_comparison/loo_rw_ch.Rdata')
loo_rw_ch_cond <- loo(bayes_rw_ch_cond_medium)
save(loo_rw_ch_cond, file = '08_loo_model_comparison/loo_rw_ch_cond.Rdata')

#compary with loo
loo_cmpr_ch=loo_compare(loo_null_ch,loo_rw_ch,loo_rw_ch_cond)
save(loo_cmpr_ch, file = '08_loo_model_comparison/loo_cmpr_ch.Rdata')
loo_cmpr_ch
...
save(lpd_point_ch, file = '08_loo_model_comparison/lpd_point_ch.Rdata')
...
save(BF_model_comparison_ch, file = '08_loo_model_comparison/BF_model_comparison_ch.Rdata')
