...
#load models
load('data/brms_data/model_null_unch_medium.Rdata')
...
save(loo_null_unch, file = 'data/brms_model_comparison_data/loo_null_unch.Rdata')
loo_rw_unch <- loo(bayes_rw_unch_medium)
save(loo_rw_unch, file = 'data/brms_model_comparison_data/loo_rw_unch.Rdata')
loo_rw_unch_cond <- loo(bayes_rw_unch_cond_medium)
save(loo_rw_unch_cond, file = 'data/brms_model_comparison_data/loo_rw_unch_cond.Rdata')

#compary with loo
loo_cmpr_unch=loo_compare(loo_null_unch,loo_rw_unch,loo_rw_unch_cond)
save(loo_cmpr_unch, file = 'data/brms_model_comparison_data/loo_cmpr_unch.Rdata')
loo_cmpr_unch
