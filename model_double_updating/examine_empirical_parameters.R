...
load(paste0(myfolder,'data/modelfit_based_on_empirical_data.rdata'))
...
p1=ggplot(data.frame(x =true.parameters[,'alpha_chosen'], y =apply(pars$alpha_chosen, 2, mean)),aes(x=x,y=y))+geom_point()+
    labs(title='',
