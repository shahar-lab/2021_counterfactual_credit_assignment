...
strong_bf_rw
plot(strong_bf_rw)
save(strong_bf_rw, file = 'data/bayes_data/strong_bf_rw')

medium_bf_rw=bayesfactor_parameters(bayes_rw_medium)
medium_bf_rw
plot(medium_bf_rw)
save(medium_bf_rw, file = 'data/bayes_data/medium_bf_rw')

weak_bf_rw=bayesfactor_parameters(bayes_rw_weak)
weak_bf_rw
plot(weak_bf_rw)
save(weak_bf_rw, file = 'data/bayes_data/weak_bf_rw')
...
save(strong_bf_rw_cond, file = 'data/bayes_data/strong_bf_rw_cond')

medium_bf_rw_cond=bayesfactor_parameters(bayes_rw_cond_medium)
medium_bf_rw_cond
plot(medium_bf_rw_cond)
save(medium_bf_rw_cond, file = 'data/bayes_data/medium_bf_rw_cond')

weak_bf_rw_cond=bayesfactor_parameters(bayes_rw_cond_weak)
weak_bf_rw_cond
plot(weak_bf_rw_cond)
save(weak_bf_rw_cond, file = 'data/bayes_data/weak_bf_rw_cond')
...
save(strong_bf_rw_rope, file = 'data/bayes_data/strong_bf_rw_rope')

medium_bf_rw_rope=bayesfactor_parameters(bayes_rw_medium,null=c(-0.0132, 0.0132))
medium_bf_rw_rope
plot(medium_bf_rw_rope)
save(medium_bf_rw_rope, file = 'data/bayes_data/medium_bf_rw_rope')

weak_bf_rw_rope=bayesfactor_parameters(bayes_rw_medium,null=c(-0.0132, 0.0132))
medium_bf_rw_rope
plot(medium_bf_rw_rope)
save(weak_bf_rw_rope, file = 'data/bayes_data/weak_bf_rw_rope')
...
save(strong_bf_rw_cond_rope, file = 'data/bayes_data/strong_bf_rw_cond_rope')
...
save(medium_bf_rw_cond_rope, file = 'data/bayes_data/medium_bf_rw_cond_rope')
...
save(weak_bf_rw_cond_rope, file = 'data/bayes_data/weak_bf_rw_cond_rope')
...
save(describe_posterior_rw_strong, file = 'data/bayes_data/describe_posterior_rw_strong.Rdata')
save(describe_posterior_rw_medium, file = 'data/bayes_data/describe_posterior_rw_medium.Rdata')
save(describe_posterior_rw_weak, file = 'data/bayes_data/describe_posterior_rw_weak.Rdata')

save(describe_posterior_rw_cond_strong, file = 'data/bayes_data/describe_posterior_rw_cond_strong.Rdata')
save(describe_posterior_rw_cond_medium, file = 'data/bayes_data/describe_posterior_rw_cond_medium.Rdata')
save(describe_posterior_rw_cond_weak, file = 'data/bayes_data/describe_posterior_rw_cond_weak.Rdata')
