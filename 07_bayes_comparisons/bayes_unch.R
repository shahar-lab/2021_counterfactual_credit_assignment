...
#reward
load('data/brms_data/model_rw_unch_strong.Rdata')
load('data/brms_data/model_rw_unch_medium.Rdata')
load('data/brms_data/model_rw_unch_weak.Rdata')

#reward*cond
load('data/brms_data/model_rw_unch_cond_strong.Rdata')
load('data/brms_data/model_rw_unch_cond_medium.Rdata')
load('data/brms_data/model_rw_unch_cond_weak.Rdata')

#prior_only
load('data/brms_data/bayes_rw_unch_medium_prior_sampling.Rdata')
load('data/brms_data/bayes_rw_cond_unch_medium_prior_sampling.Rdata')

#twoback
load('data/brms_data/model_rw_twoback_unch_cond_medium.Rdata')
#cars
load('data/brms_data/model_rw_cars_unch_medium.Rdata')
...
save(strong_bf_rw_unch, file = 'data/bayes_data/strong_bf_rw_unch.Rdata')

medium_bf_rw_unch=bayesfactor_parameters(bayes_rw_unch_medium)
medium_bf_rw_unch
plot(medium_bf_rw_unch)
save(medium_bf_rw_unch, file = 'data/bayes_data/medium_bf_rw_unch.Rdata')

weak_bf_rw_unch=bayesfactor_parameters(bayes_rw_unch_weak)
weak_bf_rw_unch
plot(weak_bf_rw_unch)
save(weak_bf_rw_unch, file = 'data/bayes_data/weak_bf_rw_unch.Rdata')
...
save(medium_bf_rw_unch_twoback, file = 'data/bayes_data/medium_bf_rw_unch_twoback.Rdata')
#cars
medium_bf_rw_cars_unch=bayesfactor_parameters(bayes_rw_cars_unch_medium)
medium_bf_rw_cars_unch
plot(medium_bf_rw_cars_unch)
save(medium_bf_rw_cars_unch, file = 'data/bayes_data/medium_bf_rw_cars_unch.Rdata')
...
save(strong_bf_rw_rope_unch, file = 'data/bayes_data/strong_bf_rw_rope_unch.Rdata')
...
save(medium_bf_rw_rope_unch, file = 'data/bayes_data/medium_bf_rw_rope_unch.Rdata')
...
save(weak_bf_rw_rope_unch, file = 'data/bayes_data/weak_bf_rw_rope_unch.Rdata')
...
save(strong_bf_rw_cond_rope_unch, file = 'data/bayes_data/strong_bf_rw_cond_rope_unch.Rdata')
...
save(medium_bf_rw_cond_rope_unch, file = 'data/bayes_data/medium_bf_rw_cond_rope_unch.Rdata')
...
save(weak_bf_rw_cond_rope_unch, file = 'data/bayes_data/weak_bf_rw_cond_rope_unch.Rdata')
...
save(medium_bf_rw_unch_twoback_rope, file = 'data/bayes_data/medium_bf_rw_unch_twoback_rope.Rdata')
...
save(medium_bf_rw_cars_unch_rope, file = 'data/bayes_data/medium_bf_rw_cars_unch_rope.Rdata')
...
save(describe_posterior_rw_unch_strong, file = 'data/bayes_data/describe_posterior_rw_unch_strong.Rdata')
save(describe_posterior_rw_unch_medium, file = 'data/bayes_data/describe_posterior_rw_unch_medium.Rdata')
save(describe_posterior_rw_unch_weak, file = 'data/bayes_data/describe_posterior_rw_unch_weak.Rdata')

save(describe_posterior_rw_unch_cond_strong, file = 'data/bayes_data/describe_posterior_rw_unch_cond_strong.Rdata')
save(describe_posterior_rw_unch_cond_medium, file = 'data/bayes_data/describe_posterior_rw_unch_cond_medium.Rdata')
save(describe_posterior_rw_unch_cond_weak, file = 'data/bayes_data/describe_posterior_rw_unch_cond_weak.Rdata')

save(describe_posterior_rw_unch_twoback, file = 'data/bayes_data/describe_posterior_rw_unch_twoback.Rdata')
save(describe_posterior_rw_unch_cars, file = 'data/bayes_data/describe_posterior_rw_unch_cars.Rdata')
