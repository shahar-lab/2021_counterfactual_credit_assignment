#-------------------------------------------------------
rm(list=ls())
load('./data/modeling_data/2PEs_100subjects_4blocks_50trials_4arms_parameters.Rdata')
load('./data/modeling_data/2PEs_100subjects_4blocks_50trials_4arms_extracted_parameters.rdata')
